...
# 3 saat sonra kendini yeniden başlatan fonksiyon
def restart_program():
    logger.info("3 saat doldu, program yeniden başlatılıyor...")
    time.sleep(3 * 3600)  # 3 saat bekle
...
if __name__ == "__main__":
    ...
    asyncio.run(main(args.master_ip, args.tig_worker_path, args.download, args.name, args.port))
    
    # Programı 3 saatte bir yeniden başlat
    restart_program()
